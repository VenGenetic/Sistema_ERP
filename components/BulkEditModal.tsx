                                    ...
                                    <div className="bg-surface-2 p-4 rounded-lg border border-subtle space-y-4">
                                        ...
                                        <div className="flex items-center gap-3 pt-2">
                                            <label className="flex items-center cursor-pointer relative group">
                                                ...
                                                <span className="ml-2 text-sm text-fg-muted font-medium group-hover:text-slate-900 dark:group-hover:text-white transition-colors">Es una compra financiera</span>
                                            </label>
                                        </div>
