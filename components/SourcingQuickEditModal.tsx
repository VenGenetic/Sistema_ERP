...
export const SourcingQuickEditModal: React.FC<SourcingQuickEditModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
            <div className="bg-white dark:bg-[#0c1117] rounded-xl shadow-2xl w-full max-w-md overflow-hidden">
                <div className="px-6 py-4 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center bg-slate-50 dark:bg-[#161b22]">
                    <div className="flex items-center gap-2 text-slate-800 dark:text-white">
                        <span className="material-symbols-outlined text-[20px] text-indigo-500">travel_explore</span>
                ...
                <div className="p-6">
                    <div className="mb-6">
                        <span className="block font-medium text-slate-900 dark:text-white">{product.name}</span>
                    ...
                    <div className="flex flex-col gap-5">
                        <div>
                            ...
                            <select
                                ...
                                className="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-[#161b22] text-slate-900 dark:text-white"
                            >
                        ...
                        <div className="flex items-center gap-3 bg-slate-50 dark:bg-[#161b22] p-3 rounded-lg border border-slate-200 dark:border-slate-700">
