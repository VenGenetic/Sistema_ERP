-- Migration: Fix POS Sale Inventory Logs
-- Description: Corrects the column 'transaction_type' to 'reference_type' in inventory_logs insert during process_pos_sale.
-- Adds user_id for audit logging and references the new order ID as a TEXT reference.
...
BEGIN
    ...
    LOOP
        ...
        -- FIX: Use reference_type and reference_id properly
