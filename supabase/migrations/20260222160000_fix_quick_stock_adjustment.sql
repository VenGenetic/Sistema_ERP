-- Migration: Fix Quick Stock Adjustment
-- Description: Fixes the process_quick_stock_adjustment to properly handle negative quantities and decrement the current_stock correctly.
