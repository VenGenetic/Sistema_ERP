-- Migration: Fix Quick Stock Adjustment (correct column name: current_stock)
-- Description: The inventory_levels table uses 'current_stock' not 'quantity'.
-- This migration corrects both RPC functions.
...
BEGIN
    ...
    LOOP
        ...
        -- Pessimistic lock — using correct column: current_stock
